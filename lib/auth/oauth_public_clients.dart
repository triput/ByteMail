...
// Description: Synesis-owned public OAuth client IDs shipped with the app.
...
///
/// These Application (client) IDs are **not secrets** — they identify Synesis to
...
abstract final class OAuthPublicClients {
  ...
  /// Redirects: `http://127.0.0.1:8766/callback`, `synesis://google-auth`.
